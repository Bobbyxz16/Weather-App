...
// Retrieve weather data from API. This backend logic will fecth the latest weather
// data from external API and return it
// This GUI will display the data to the user
    ...
    public static JSONArray getLocationData(String locationName){
        ...
        try {
            ...
            if (conn.getResponseCode() != 200){
                ...
                // Read and stare the resulting json data into our string builder
                while (scanner.hasNext()) {
                    resultJSON.append(scanner.nextLine());
                }
